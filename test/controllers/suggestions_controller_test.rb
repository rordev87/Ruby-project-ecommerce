...
class SuggestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create suggestion" do
    assert_difference('Suggestion.count') do
      post suggestions_url, params: { suggestion: { category_name: @suggestion.category_name, description: @suggestion.description, image: @suggestion.image, price: @suggestion.price, product_name: @suggestion.product_name } }
    end
  ...
  test "should update suggestion" do
    patch suggestion_url(@suggestion), params: { suggestion: { category_name: @suggestion.category_name, description: @suggestion.description, image: @suggestion.image, price: @suggestion.price, product_name: @suggestion.product_name } }
